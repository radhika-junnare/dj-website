        ...
        <div className="flex flex-wrap justify-center gap-6 max-w-4xl mx-auto">
          {contactItems.map((item) => (
            <a
              ...
              className="bg-slate-800 border border-slate-700 rounded-xl p-6 text-center hover:border-amber-400/50 transition-all group w-44"
            >
              <div className="text-amber-400 mb-3 flex justify-center group-hover:scale-110 transition-transform">
                {item.icon}
              </div>
              <p className="text-slate-400 text-xs uppercase tracking-wider group-hover:text-amber-400 transition-colors">
                {item.label}
              </p>
            </a>
          ))}
